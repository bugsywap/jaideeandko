export const clients = [
  { name: '3 Degrees', label: 'Charity Social Platform', src: '/img/3-deg.png' },
  { name: 'GC Logo', label: 'Aquascaping Specialists', src: '/img/GClogo_No Background.png' },
  { name: 'NIE', label: 'Educational Institute', src: '/img/NIE.png' },
  { name: 'V1', label: 'Podcast Agency', src: '/img/V1_White.png' },
  ...
  { name: 'SCH', label: 'Non - Profit', src: '/img/sch1.png' },
