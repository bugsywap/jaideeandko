...
export const metadata = {
  title: "Our Process | Jaidee & Ko",
  description: "How we fast-track ideas and capture your expertise. A look into our strategy, scripting, and production process.",
}
        ...
        <div className="container mx-auto px-6 max-w-7xl py-24">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 relative z-10">
            {processes.map((process) => (
              <Card key={process.step} className="bg-surface border-border overflow-hidden group hover:border-primary transition-colors duration-300">
