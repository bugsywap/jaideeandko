...
export const metadata = {
  title: "Social Media Video Agency in Singapore | Jaidee & Ko",
  description: "Stop scrolling and start connecting. We produce short-form, high-ticket social media video content designed for LinkedIn, TikTok, and Instagram.",
}
